...
class AdminHomeController extends Controller
{
    public function index()
    {
        ...
        $populationMapping = [
            ...
            'Bongtud Poblacion (East West) Tandag, Surigao del Sur' => 834,
            'Buenavista Tandag, Surigao del Sur' => 449,
            'Dagocdoc (Poblacion) Tandag, Surigao del Sur' => 517,
            'Mabua Tandag, Surigao del Sur' => 1166,
            'Mabuhay Tandag, Surigao del Sur' => 112,
            'Maitum Tandag, Surigao del Sur' => 263,
            'Maticdum Tandag, Surigao del Sur' => 116,
            'Pandanon Tandag, Surigao del Sur' => 142,
            'Pangi Tandag, Surigao del Sur' => 141,
            'Quezon Tandag, Surigao del Sur' => 273,
            'Rosario Tandag, Surigao del Sur' => 603,
            'Salvacion Tandag, Surigao del Sur' => 123,
            'San Agustin Norte Tandag, Surigao del Sur' => 331,
            'San Agustin Sur Tandag, Surigao del Sur' => 815,
            'San Antonio Tandag, Surigao del Sur' => 125,
            'San Isidro Tandag, Surigao del Sur' => 145,
            'San Jose Tandag, Surigao del Sur' => 123,
            'Telaje Tandag, Surigao del Sur' => 1085,
        ];
