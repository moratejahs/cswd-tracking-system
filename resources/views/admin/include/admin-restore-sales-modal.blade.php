<div class="text-left modal fade" id="restore-sales-modal" tabindex="-1" aria-labelledby="myModalLabel4"
    ...
    <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="saleRestoreForm" method="POST">
                    @csrf
                    <div class="row">
                        <input type="hidden" id="restore-sale-id" name="id">
