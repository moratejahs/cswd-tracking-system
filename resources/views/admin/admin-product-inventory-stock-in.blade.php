            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="product-inventory-stock-in-record">
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->unit }}</td>
                                        <td class="text-center">{{ intval($product->quantity) }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a id="edit-product-stock-in" href="javascript:void(0)"
                                                data-url="{{ route('get.inventory', $product->product_id) }}"
