    ...
    <nav class="pt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" data-aos="fade-down">
        ...
        <div>
            <span
                ...
                Manage Beneficiary Qualifications
            </span>
        </div>
    </nav>
    <br>
            ...
            <div class="card" data-aos="fade-left">
                <div class="card-body">
                    <button type="button" class="btn-sm block btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#createBeneficiaryQualification">
                        Add Qualification
                    </button>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="qualificationTables">
...
@section('scripts')
    ...
    {{-- Custom Scripts --}}
    <script src="{{ asset('js/qualification/index.js') }}"></script>
    <script src="{{ asset('js/qualification/delete.js') }}"></script>
    <script src="{{ asset('js/qualification/update.js') }}"></script>
@endsection
